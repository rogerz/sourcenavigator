# Copy from dist/aclocal munged for SNav to allow db4 to be built in 1.85
# compatibility mode by default et al
...
AC_ARG_ENABLE(cryptography,
	...
	[db_cv_build_cryptography="$enable-cryptography"], [db_cv_build_cryptography="no"])
