...
#ident "$Id: pform_dump.cc,v 1.1 2000/12/21 21:57:13 jrandrews Exp $"
#endif
...
tt = fopen("dump.log","a");      
fprintf(tt,"line %d\n",l);
fprintf(tt,"check buf %s line %d\n",buf,l);
fflush(tt);
*/

/*      
       sn_insert_xref(SN_REF_TO_GLOB_VAR, SN_FUNC_DEF, SN_REF_SCOPE_GLOBAL,
	  NULL, buf, NULL, NULL, buf , NULL, sn_current_file(),
	         l, SN_REF_WRITE);
		 */

/*
        sn_insert_symbol(SN_GLOB_VAR_DEF, NULL, buf, sn_current_file(),
              l, 0, l, 0,
