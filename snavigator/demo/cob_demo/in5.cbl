       ...
       ENVIRONMENT DIVISION.
         CONFIGURATION SECTION.
           ...
           OBJECT-COMPUTER. PC 08.15
             ...
             console is crt cursor is cur crt status is stat
      ...
      *
       ...
       DECLARATIVES.
         s1 section.
           USE AFTER ERROR PROCEDURE ON FILE-1.                         93.07.07
                MOVE 100 TO FIELD-A.                                    93.07.07
         s2 section.
           USE AFTER EXCEPTION PROCEDURE ON I-O.                        93.07.07
                DISPLAY 'GIVE UP'                                       93.07.07
                PERFORM EOJ.                                            93.07.07
       END DECLARATIVES.                                                94.10.19
                                                                        93.07.07
             GO TO X1.
           P0.
             CLOSE a d  b.
